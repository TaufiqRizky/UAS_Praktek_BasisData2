              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="js-sweetalert">
                                     ...
                                     <button class="btn btn-primary" data-id="{{$val->id}}" data-waldos="{{$val->waldos}}"  data-fak="{{$val->kelas}}" data-type="edit" > <i class="fas fa-pencil-alt"></i> Edit</button>
...
<div class="modal fade" id="smallmodal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="post" action="{{ route('admin.kelas.store') }}">
                        ...
                        <div class="form-group col-md-12">
                          <label for="waldos">waldos</label>
                          <select name="waldos" id="waldos" class="form-control">
              ...
              <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="smallmodalLabel">Edit kelas</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body">
                      <form method="post" action="{{ route('admin.kelas.update') }}">
                        ...
                        <div class="form-group col-md-12">
                          ...
                          <input type="text" class="form-control" name="ekelas" id="ekelas" placeholder="Masukan Nama kelas">
                        </div>
                        <div class="form-group col-md-12">
                          <label for="waldos">waldos</label>
                          <select name="ewaldos" id="ewaldos" class="form-control">
                            <option>--pilih dosen wali--</option>
                            @foreach($dosen as $row)
                              <option value="{{$row->nip}}">{{$row->nip}} - {{$row->nama}}</option>
                            @endforeach
